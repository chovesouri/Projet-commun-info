...
int main(){
    ...
    printf("Tour numéro %d\n",nombredetour);
        ...
        nombredetour++;
    }while((equipe1[0].pvcourants>0 && equipe[1].pvcourants>0 && equipe1[2].pvcourants) && (equipe2[1].pvcourants>0 && equip2[2].pvcourants>0 && equipe2[2].pvcourants) );//condition de fin de combat
